...
func (c *userServiceClient) GetUserByName(ctx context.Context, in *Username, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *userServiceClient) GetUser(ctx context.Context, in *Username, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUserServiceServer) GetUserByName(context.Context, *Username) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByName not implemented")
}
func (UnimplementedUserServiceServer) GetUser(context.Context, *Username) (*User, error) {
...
func _UserService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUser(ctx, req.(*Username))
	}
	return interceptor(ctx, in, info, handler)
}
